...
class OutcomesTableSeeder extends Seeder
{
    ...
    public function run()
    {
         ...
         */
        $topic = Topic::where('name', 'Number Concept')->get()->first();
        ...
        $topic = Topic::where('name', 'Whole Numbers')->get()->first();
         ...
         */
        $topic = Topic::where('name', 'Fractions')->get()->first();
        ...
        $topic = Topic::where('name', 'Addition')->get()->first();
        ...
        $topic = Topic::where('name', 'subtraction')->get()->first();
        ...
        $topic = Topic::where('name', 'multiplication')->get()->first();
        ...
        $topic = Topic::where('name', 'Division')->get()->first();
        ...
        $topic = Topic::where('name', 'Length')->get()->first();
        ...
        $topic = Topic::where('name', 'Mass')->get()->first();
        ...
        $topic = Topic::where('name', 'Capacity')->get()->first();
        ...
        $topic = Topic::where('name', 'Time')->get()->first();
        ...
        $topic = Topic::where('name', 'Money')->get()->first();
        ...
        $topic = Topic::where('name', 'Position and Direction')->get()->first();
        ...
        $topic = Topic::where('name', 'Shapes')->get()->first();
