...
@section('content')
    <div class="container-fluid">
        <a href="{{ Route('teacher.students.create') }}" class="btn btn-primary my-3">Add New Student</a>
          ...
          <form style="display: inline-block float-left" action="" method="POST">
            ...
            <div class="box">
              ...
              <div class="box-body table-responsive no-padding">
                @component('components.teacher.tables.students.performance', [
                  'students' => $students,
                  'subjects' => $subjects
                ])   
                @endcomponent
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <a href="{{ Route('teacher.students.export.csv-template') }}" class="btn btn-primary">Download CSV Template </a>
            <a href="{{ Route('teacher.students.import') }}" class="btn btn-success">Import</a>
          </div>
